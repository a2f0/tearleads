...
Generated: `2026-03-10T13:37:30.384Z` via `node --experimental-strip-types scripts/bun/generateCompatibilityInventory.ts`.
...
| --- | ---: | --- |
| `@tearleads/client` | 30 | vi.hoisted (44), vi.importActual (86), vi.mock(importOriginal) (106), vi.waitFor (8), import.meta.glob (1), vi.resetModules (46), vi.mocked (435), vi.stubEnv (22), DOM setup (4 indicators; see Package Inventory), test script is vitest-primary |
...
| --- | ---: | --- | --- | --- | --- | --- |
| `@tearleads/client` | 607 | `vitest-primary` | no | vi.hoisted:44, vi.importActual:86, vi.mock(importOriginal):106, vi.waitFor:8, import.meta.glob:1, vi.resetModules:46, vi.mocked:435, vi.stubEnv:22 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
