...
Generated: `2026-03-08T21:23:30.743Z` via `node --experimental-strip-types scripts/bun/generateCompatibilityInventory.ts`.
...
| `@tearleads/client` | 20 | vi.hoisted (70), vi.importActual (80), vi.resetModules (44), vi.mocked (442), vi.stubEnv (22), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), test script is vitest-primary |
...
| `@tearleads/client` | 599 | `vitest-primary` | no | vi.hoisted:70, vi.importActual:80, vi.resetModules:44, vi.mocked:442, vi.stubEnv:22 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
