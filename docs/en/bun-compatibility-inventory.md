...
| `@tearleads/api` | 157 | `vitest-primary` | no | vi.hoisted:61, vi.importActual:19, vi.mock(importOriginal):1, vi.waitFor:3, vi.resetModules:9, vi.mocked:4, vi.stubEnv:41 | none | `high-remediation` |
