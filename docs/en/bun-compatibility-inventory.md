...
Generated: `2026-03-09T19:02:09.208Z` via `node --experimental-strip-types scripts/bun/generateCompatibilityInventory.ts`.
...
| --- | ---: | --- |
| `@tearleads/client` | 30 | vi.hoisted (72), vi.importActual (83), vi.mock(importOriginal) (100), vi.waitFor (8), import.meta.glob (1), vi.resetModules (46), vi.mocked (444), vi.stubEnv (22), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), test script is vitest-primary |
...
| --- | ---: | --- | --- | --- | --- | --- |
| `@tearleads/client` | 604 | `vitest-primary` | no | vi.hoisted:72, vi.importActual:83, vi.mock(importOriginal):100, vi.waitFor:8, import.meta.glob:1, vi.resetModules:46, vi.mocked:444, vi.stubEnv:22 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
