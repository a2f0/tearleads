...
Generated: `2026-03-11T21:55:08.801Z` via `node --experimental-strip-types scripts/bun/generateCompatibilityInventory.ts`.
...
| --- | ---: | --- |
| `@tearleads/client` | 26 | vi.hoisted (40), vi.importActual (75), vi.mock(importOriginal) (106), vi.waitFor (8), import.meta.glob (1), vi.mocked (199), DOM setup (4 indicators; see Package Inventory), test script is vitest-primary |
...
| --- | ---: | --- | --- | --- | --- | --- |
| `@tearleads/client` | 594 | `vitest-primary` | no | vi.hoisted:40, vi.importActual:75, vi.mock(importOriginal):106, vi.waitFor:8, import.meta.glob:1, vi.mocked:199 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
