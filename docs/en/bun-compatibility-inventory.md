...
Generated: `2026-03-08T20:06:25.215Z` via `node --experimental-strip-types scripts/bun/generateCompatibilityInventory.ts`.
...
| `@tearleads/client` | 20 | vi.hoisted (70), vi.importActual (80), vi.resetModules (47), vi.mocked (442), vi.stubEnv (22), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), test script is vitest-primary |
| `@tearleads/keychain` | 19 | vi.hoisted (3), vi.importActual (1), vi.resetModules (2), vi.mocked (50), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), test script is vitest-primary |
| `@tearleads/api` | 18 | vi.hoisted (56), vi.importActual (19), vi.resetModules (9), vi.mocked (4), vi.stubEnv (41), test script is vitest-primary |
...
| `@tearleads/mls-chat` | 8 | vi.hoisted (1), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), transitional test script uses bun auto-fallback |
...
| `@tearleads/console` | 7 | vi.importActual (1), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), transitional test script uses bun auto-fallback |
...
| `@tearleads/help` | 7 | vi.importActual (1), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), transitional test script uses bun auto-fallback |
...
| `@tearleads/analytics` | 5 | vi.mocked (2), DOM setup (@testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency), transitional test script uses bun auto-fallback |
...
| `@tearleads/client` | 603 | `vitest-primary` | no | vi.hoisted:70, vi.importActual:80, vi.resetModules:47, vi.mocked:442, vi.stubEnv:22 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
| `@tearleads/keychain` | 20 | `vitest-primary` | no | vi.hoisted:3, vi.importActual:1, vi.resetModules:2, vi.mocked:50 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
| `@tearleads/api` | 151 | `vitest-primary` | no | vi.hoisted:56, vi.importActual:19, vi.resetModules:9, vi.mocked:4, vi.stubEnv:41 | none | `high-remediation` |
...
| `@tearleads/mls-chat` | 8 | `bun-auto-fallback` | yes | vi.hoisted:1 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
...
| `@tearleads/console` | 5 | `bun-auto-fallback` | yes | vi.importActual:1 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
...
| `@tearleads/help` | 6 | `bun-auto-fallback` | yes | vi.importActual:1 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
| `@tearleads/chrome-extension` | 8 | `bun-auto-fallback` | yes | vi.resetModules:7 | jsdom dependency | `high-remediation` |
| `@tearleads/analytics` | 19 | `bun-auto-fallback` | yes | vi.mocked:2 | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `high-remediation` |
...
| `@tearleads/notifications` | 7 | `bun-auto-fallback` | yes | none | @testing-library/jest-dom dependency; @testing-library/jest-dom/vitest import; DOM test environment in vitest config; jsdom dependency | `needs-remediation` |
