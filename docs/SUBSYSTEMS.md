...
| **Accounts** | Account lifecycle state and account remote-data retention/purge workflows. | `services/accounts` facade | `services/accounts/`, `workflows/accounts/`, `accounts/` |
