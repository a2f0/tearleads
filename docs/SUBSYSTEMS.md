...
| **Organization Read Models** | Org projections, roster/profile writes, and key rewraps. | `tearleads.organizations` facade; `workflows/organizations` | `workflows/organizations/`, `client/organizations.ts`, `client/organizationGroupPresentation.ts`, `client/organizationReadModels.ts`, `client/organizationMetadataReshare.ts`, `client/organizationMetadataReshareCoordinator.ts`, `client/organizationRootReshare.ts`, `client/organizationRootReshareCoordinator.ts` |
