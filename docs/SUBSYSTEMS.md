...
| **Organization Read Models** | Org directory/groups/grants/usage/user-detail read models, roster/profile mutations, and reserved-grant rewrap orchestration for the client. | `tearleads.organizations` facade; `workflows/organizations` | `workflows/organizations/`, `client/organizations.ts`, `client/organizationMetadataReshare.ts`, `client/organizationMetadataReshareCoordinator.ts`, `client/organizationRootReshare.ts`, `client/organizationRootReshareCoordinator.ts` |
