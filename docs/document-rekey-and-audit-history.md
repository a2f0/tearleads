...
When a current target change is additive, the client can keep using the
...
This phase targets the signed write path.
...
the mutation services call the audit helpers.
