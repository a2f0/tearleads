...
| `TL-NACCT-002` | Attributable disablement/deletion-mark actions and session revocation | [`packages/api/src/routes/admin/users/patchId.ts`](../../../packages/api/src/routes/admin/users/patchId.ts), [`packages/api/src/migrations/v017.ts`](../../../packages/api/src/migrations/v017.ts) | [`packages/api/src/connect/services/adminService.ts`](../../../packages/api/src/connect/services/adminService.ts) |
