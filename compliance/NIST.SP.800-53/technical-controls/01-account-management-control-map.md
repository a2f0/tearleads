...
| `TL-NACCT-002` | Attributable disablement/deletion-mark actions and session revocation | [`packages/api/src/connect/services/adminDirectUsers.ts`](../../../packages/api/src/connect/services/adminDirectUsers.ts), [`packages/api/src/migrations/v001.ts`](../../../packages/api/src/migrations/v001.ts) | [`packages/api/src/connect/services/adminServiceV2.test.ts`](../../../packages/api/src/connect/services/adminServiceV2.test.ts) |
