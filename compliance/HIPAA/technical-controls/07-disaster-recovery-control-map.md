...
| --- | --- | --- | --- |
| `TL-CR-001` | ECR container registries with AES-256 encryption | 164.312(a)(2)(iv) | `terraform/modules/aws-ci-artifacts/main.tf` |
| `TL-CR-002` | ECR scan-on-push for vulnerability detection | 164.308(a)(1)(ii)(D) | `terraform/modules/aws-ci-artifacts/main.tf` |
...
| `TL-CR-004` | ECR lifecycle policies for image retention | 164.310(d)(2)(i) | `terraform/modules/aws-ci-artifacts/main.tf` |
| `TL-DR-001` | Per-stack S3 backend with unique state keys | 164.308(a)(7)(ii)(A) | `terraform/stacks/*/versions.tf` |
| `TL-DR-002` | DynamoDB state locking for concurrent access | 164.308(a)(7)(ii)(A) | `terraform/bootstrap/main.tf` |
| `TL-DR-003` | Documented container build/push/deploy workflow | 164.308(a)(7)(ii)(B) | `terraform/docs/container-deployments.md` |
