...
| `TL-NET-004` | Infrastructure Firewall | `terraform/modules/hetzner-server/main.tf`, `terraform/stacks/prod/vpn/main.tf`, `terraform/stacks/shared/tailscale/main.tf` | Hetzner Cloud firewall + Tailscale ACL policy with explicit access rules |
