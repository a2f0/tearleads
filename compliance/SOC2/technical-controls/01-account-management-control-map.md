...
| `TL-ACCT-002` | Disable action records actor and timestamp; active sessions revoked | [`packages/api/src/connect/services/adminDirectUsers.ts`](../../../packages/api/src/connect/services/adminDirectUsers.ts) | [`packages/api/src/connect/services/adminService.ts`](../../../packages/api/src/connect/services/adminService.ts) |
| `TL-ACCT-003` | Deletion-mark action records actor and timestamp | [`packages/api/src/connect/services/adminDirectUsers.ts`](../../../packages/api/src/connect/services/adminDirectUsers.ts) | [`packages/api/src/connect/services/adminService.ts`](../../../packages/api/src/connect/services/adminService.ts) |
