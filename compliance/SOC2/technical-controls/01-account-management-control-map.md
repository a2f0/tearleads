...
| `TL-ACCT-002` | Disable action records actor and timestamp; active sessions revoked | [`packages/api/src/connect/services/adminDirectUsers.ts`](../../../packages/api/src/connect/services/adminDirectUsers.ts) | [`packages/api/src/connect/services/adminServiceV2.test.ts`](../../../packages/api/src/connect/services/adminServiceV2.test.ts) |
| `TL-ACCT-003` | Deletion-mark action records actor and timestamp | [`packages/api/src/connect/services/adminDirectUsers.ts`](../../../packages/api/src/connect/services/adminDirectUsers.ts) | [`packages/api/src/connect/services/adminServiceV2.test.ts`](../../../packages/api/src/connect/services/adminServiceV2.test.ts) |
