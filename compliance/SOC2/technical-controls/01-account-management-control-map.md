...
| `TL-ACCT-002` | Disable action records actor and timestamp; active sessions revoked | [`packages/api/src/routes/admin/users/patchId.ts`](../../../packages/api/src/routes/admin/users/patchId.ts) | [`packages/api/src/routes/admin/users.test.ts`](../../../packages/api/src/routes/admin/users.test.ts) |
| `TL-ACCT-003` | Deletion-mark action records actor and timestamp | [`packages/api/src/routes/admin/users/patchId.ts`](../../../packages/api/src/routes/admin/users/patchId.ts) | [`packages/api/src/routes/admin/users.test.ts`](../../../packages/api/src/routes/admin/users.test.ts) |
