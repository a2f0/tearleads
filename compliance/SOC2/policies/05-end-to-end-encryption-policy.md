...
1. Planned baseline control: MLS group encryption via `@tearleads/app-mls-chat` package (`TL-E2E-001`).
2. Planned baseline control: Ed25519 credential generation and key package signing (`TL-E2E-002`).
3. Planned baseline control: Epoch-based key evolution for forward secrecy (`TL-E2E-003`).
