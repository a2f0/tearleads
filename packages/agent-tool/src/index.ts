 ...
 *                               commit (defaults to the PR title), requiring the
 *                               `(#<pr>)` reference on the prepared commit.
 *                               Optional
 *                               [sha], [base-ref], and [base-oid] bind the
 *                               atomic push to the reviewed squash and base.
 */
