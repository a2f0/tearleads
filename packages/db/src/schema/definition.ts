...
/**
 * All canonical runtime table definitions.
 *
 * Guardrail: retired legacy VFS tables are intentionally omitted from this
 * inventory and additionally blocked by runtime filter deny-lists below.
 */
