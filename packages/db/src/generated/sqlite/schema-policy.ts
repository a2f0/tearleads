 ...
 */
export const vfsSharePolicySelectors = sqliteTable(
  'vfs_share_policy_selectors',
  {
    ...
    includeRoot: integer('include_root', { mode: 'boolean' })
      .notNull()
      .default(true),
    objectTypes: text('object_types'),
 ...
 */
export const vfsSharePolicyPrincipals = sqliteTable(
 ...
 */
export const vfsAclEntryProvenance = sqliteTable(
