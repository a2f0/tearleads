/**
 * Unit tests for native-secure-storage module: core operations.
 *
 * These tests verify biometric availability, key storage/retrieval,
 * and session checking on mobile platforms (iOS/Android).
 */
