/**
 * Unit tests for native-secure-storage module: session persistence flows,
 * instance isolation, and keystore tracking.
 *
 * These tests verify end-to-end session persist/restore cycles,
 * instance namespace isolation, and keystore instance tracking.
 */
...
describe('native-secure-storage sessions and isolation', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
