/**
 * Tests for the instance registry: initialization, queries, and clearing.
 *
...
const mockIsTestInstance = isTestInstance;
...
describe('instance-registry initialization and queries', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockStore.clear();
    resetInitializationState();
