...
describe('DurationChart color cycling', () => {
...
describe('DurationChart failed event handling', () => {
...
describe('DurationChart data grouping', () => {
...
describe('DurationChart renders with various duration ranges', () => {
...
describe('DurationChart renders with different time filters', () => {
...
describe('DurationChart event name formatting edge cases', () => {
...
describe('DurationChart empty selection behavior', () => {
...
describe('DurationChart container dimension handling', () => {
