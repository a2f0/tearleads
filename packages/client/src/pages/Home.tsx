...
export function Home() {
  ...
  const gridTemplateColumns = getMobileGridTemplateColumns();
  ...
  const handlePointerUp = useCallback(() => {
    ...
    if (isSelectingRef.current && selectionBox) {
      ...
      const minDragDistance = getMinSelectionDragDistance();
      if (boxWidth > minDragDistance || boxHeight > minDragDistance) {
