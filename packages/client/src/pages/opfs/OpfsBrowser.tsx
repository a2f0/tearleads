...
export interface OpfsBrowserHandle {
  refresh: () => void;
  expandAll: () => void;
  collapseAll: () => void;
}
...
export const OpfsBrowser = forwardRef<OpfsBrowserHandle, OpfsBrowserProps>(
  function OpfsBrowser(
    { showHeader = true, showRefreshButton = true }: OpfsBrowserProps,
    ref
  ) {
    ...
    const expandAll = useCallback(() => {
      setExpandedPaths(new Set(collectAllPaths(entries, '')));
    }, [entries]);
    ...
    useImperativeHandle(
      ref,
      () => ({
        refresh: fetchOpfsContents,
        expandAll,
        collapseAll
      }),
      [collapseAll, expandAll, fetchOpfsContents]
    );
