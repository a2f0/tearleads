...
export const adminRoutes = {
  ...
  organizations: {
    ...
    create: (data: CreateOrganizationRequest) =>
      adminV2Routes.organizations.create(data),
    update: (id: string, data: UpdateOrganizationRequest) =>
      adminV2Routes.organizations.update(id, data),
    delete: (id: string) => adminV2Routes.organizations.delete(id)
  },
  users: {
    list: (options?: { organizationId?: string }) => {
    ...
    update: (id: string, data: AdminUserUpdatePayload) =>
      adminV2Routes.users.update(id, data)
  }
};
