...
import type { AuthServiceDeleteSessionRequest } from '@tearleads/shared/gen/tearleads/v2/auth_pb';
import {
...
const REFRESH_COOKIE_PATH = '/v1/connect/tearleads.v2.AuthService';
