...
function printUsage(): void {
  console.log(
    [
      ...
      '  node --import tsx scripts/createAccount.ts -- --email user@example.com --password "secret"',
      '  node --import tsx scripts/createAccount.ts -- --email user@example.com --password-stdin',
      '',
      'Options:',
