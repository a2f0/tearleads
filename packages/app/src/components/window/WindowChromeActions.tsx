...
export function selectBackAction(
  items: ReadonlyMap<object, RegisteredWindowBackAction>,
): RegisteredWindowBackAction | null {
  let selected: RegisteredWindowBackAction | null = null;
