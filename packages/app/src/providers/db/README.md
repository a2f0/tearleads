...
- Worker-thread plumbing still lives in `@tearleads/sqlite-worker` behind the SDK facade.
...
- Non-browser or custom hosts should provide their own `createSQLiteWorkerRuntime` through `AppHostConfig`.
