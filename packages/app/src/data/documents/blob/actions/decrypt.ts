...
import { assertDocumentWriterProjectionConsistent } from "../../documentRuntime";
...
import { unwrapBlobContentKey } from "../shared/projection";
import {
  parseBlobEncryptedBytes,
  readDocumentManifestIdentity,
} from "../shared/readers";
import { assertBlobContentKeyBundleTargetHash } from "../shared/responses";
import type { DecryptDocumentAttachmentBlobInput } from "../shared/types";
