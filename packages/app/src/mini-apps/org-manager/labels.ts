export const ORG_MANAGER_LABELS = {
  ...
  billingActivationUnconfirmed:
    "We couldn't confirm the billing update yet. Refresh to check or choose another plan.",
  ...
  billingSubscriptionMoveMessage:
    "This checks the Apple or Google account on this device and moves its SymCrypt subscription to this personal organization. The previous personal organization will stop syncing, and its remote sync data becomes eligible for permanent deletion after 30 days. Its encrypted data and identity keys are not moved. If you need that data, cancel and recover the original identity in Identity Manager first.",
  ...
  billingUnavailable: "Billing details didn't load. Try Refresh.",
  billingUpgradePlan: "Upgrade",
  builtIn: "Built-in",
  cancel: "Cancel",
  container: "Container",
  ...
  directory: "Roster",
  directoryUnavailable: "The roster hasn't synced yet. Try Refresh.",
  ...
  grantsUnavailable: "Grants haven't synced yet. Try Refresh.",
  ...
  organizationDataUsage: "Synced data usage",
  ...
  policyHistoryUnavailable: "Policy history hasn't synced yet. Try Refresh.",
  policyRoleNone: "none",
  ...
  usageCategoryContainerMetadata: "System · Container metadata",
  usageCategoryOrganizationMetadata: "System · Org metadata",
  usageCategoryRosterProfiles: "System · Roster profiles",
  usageCategoryUser: "User · Documents",
  usageData: "Data",
  usageDefinition:
    "Counts encrypted document updates and blobs stored by sync. Local-only data and organization records are not included.",
  ...
  usageTotal: "Total",
  usageSyncOff:
    "Sync is off for this organization, so locally queued metadata and files may not appear here.",
  usageUpdate: "update",
  usageUpdatesUnit: "updates",
  usageUnavailable: "Usage hasn't synced yet. Try Refresh.",
  user: "User",
