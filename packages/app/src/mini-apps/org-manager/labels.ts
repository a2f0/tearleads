...
export const ORG_MANAGER_LABELS = {
  ...
  policyGroupCreated: "Group created",
  policyGroupUpdated: "Group updated",
  policyGroupDeleted: "Group deleted",
  policyGroupDetailsUnavailable:
    "Group change details are unavailable. Try Refresh when online.",
