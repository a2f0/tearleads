// Generated by openapi-typescript from the SymCrypt OpenAPI projection; do not edit.
...
export interface operations {
        ...
        responses: {
            ...
            200: {
                headers: {
                    ...
                    "x-symcrypt-blob-byte-length"?: string;
                    "x-symcrypt-blob-id": string;
                    "x-symcrypt-blob-sha256": string;
                    [name: string]: unknown;
                };
                content: {
    ...
    "blobs.multipartStages.parts.upload": {
        parameters: {
            query?: never;
            header: {
                "x-symcrypt-blob-part-byte-length": string;
                "x-symcrypt-blob-part-sha256": string;
                "x-symcrypt-blob-upload-id": string;
            };
            path: {
                partNumber: number;
                stageId: string;
