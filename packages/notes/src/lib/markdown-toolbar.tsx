...
/**
 * Creates a markdown toolbar commands filter with a configurable tooltip z-index
 */
export function createMarkdownToolbarFilter(
  ...
  const renderToolbarButton = (
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent style={{ zIndex: tooltipZIndex }}>
          {tooltipLabel}
        </TooltipContent>
      </Tooltip>
    );
...
/**
 * Default markdown toolbar commands filter with standard z-index
 */
export const markdownToolbarCommandsFilter: CommandFilter =
  createMarkdownToolbarFilter(10050);
