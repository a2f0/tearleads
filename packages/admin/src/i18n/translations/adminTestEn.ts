...
export const adminTestEn = {
  ...
  "admin": {
    ...
    "createOrganizationDescription": "Create a new organization to group users and teams.",
    "editGroup": "Edit Group",
    "editUser": "Edit User",
    "deleteGroup": "Delete Group",
    "deleteGroupConfirm": "Are you sure you want to delete \"{{name}}\"? This will remove all members from the group.",
    "deleteOrganization": "Delete Organization",
    "deleteOrganizationConfirm": "Are you sure you want to delete \"{{name}}\"? This will remove all organization memberships.",
