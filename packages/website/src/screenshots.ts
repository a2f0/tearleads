...
// build that renders many figures and routes reads the file once. Callers pass
// Astro's publicDir: the astro:config/server virtual module is imported only
// from .astro files, which the architecture check does not resolve.
