...
export interface ContainerDocumentsPersistence {
  deleteContainer: (
    execSql: ExecSql,
    containerId: string,
...
async function saveContainerDocumentsContainerRows(input: {
  container: ContainerRecord;
...
export const sqlContainerDocumentsPersistence: ContainerDocumentsPersistence = {
  async deleteContainer(execSql, containerId, options) {
    await sqlContainerDocumentsPersistence.deleteContainers(
      execSql,
      [containerId],
      options,
    );
  ...
  async saveContainer(execSql, container, record, options) {
    return runSerializedSqlMutation(execSql, async (lockedExecSql) => {
      ...
      return getClientSQLitePersistenceRuntime(lockedExecSql).transaction(
        async (tx) =>
          saveContainerDocumentsContainerRows({
            container,
    ...
    return runSerializedSqlMutation(execSql, async (lockedExecSql) => {
      ...
      return getClientSQLitePersistenceRuntime(lockedExecSql).transaction(
        async (tx) => {
          ...
          return saveContainerDocumentsContainerRows({
            container,
            record,
            tx,
            localUpdatedAt,
