...
// and the server independently enforces writes, so this only down-grades legacy
// or un-hydrated data (which the next sync corrects) rather than blocking owners.
