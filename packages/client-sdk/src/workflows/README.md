...
| `documents` | Platform runtime | Document creation, persistence, sync, projection keys, document link-set helpers, and the discard-to-shell escape hatch for documents whose queued writes can no longer sync. |
