...
| `container-documents` | Platform read model and runtime | Container tree projections, container metadata documents, document discovery, document links, and sync helpers. Product UI routes, panels, menus, and selection state belong in `packages/app`. |
