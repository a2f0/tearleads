...
export async function createRemoteContainer(input: {
  ...
  if (!author || !parentSecretKey) {
    input.runtime.log(
      "Container documents: skipped container create because the writer context is unavailable.",
    );
    return null;
  }
...
export async function shareRemoteContainer(input: {
  ...
  if (!author || !targetSecretKey) {
    input.runtime.log(
      "Container documents: skipped container share because the writer context is unavailable.",
    );
    return null;
  }
...
export async function shareRemoteContainerWithGroup(input: {
  ...
  if (!author || !targetSecretKey) {
    input.runtime.log(
      "Container documents: skipped container group share because the writer context is unavailable.",
    );
    return null;
  }
...
export async function moveRemoteContainer(input: {
  ...
  if (!author || !targetSecretKey) {
    input.runtime.log(
      "Container documents: skipped container move because the writer context is unavailable.",
    );
    return null;
  }
