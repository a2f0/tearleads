...
output "resource_group_id" {
  ...
  value       = azurerm_resource_group.tee.id
}
...
output "vm_private_ip" {
  description = "Private IP of the confidential VM"
  value       = azurerm_network_interface.confidential_vm.private_ip_address
}
...
output "key_vault_name" {
  ...
  value       = azurerm_key_vault.tee.name
}

output "managed_identity_id" {
  description = "ID of the VM's managed identity"
  value       = azurerm_user_assigned_identity.confidential_vm.id
}
...
output "managed_identity_principal_id" {
  ...
  value       = azurerm_user_assigned_identity.confidential_vm.principal_id
}

output "ssh_command" {
  description = "SSH command to connect to the VM"
  value       = "ssh ${var.admin_username}@${azurerm_public_ip.confidential_vm.ip_address}"
}
