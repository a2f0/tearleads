...
5. Selection guidance: the script prints the scoring rubric (`severity * 3 + blast_radius * 2 + confidence * 2 - effort`) and reminds you to capture the baseline metric, branch only after a candidate is chosen, and enforce the quality delta gate before opening a PR.
