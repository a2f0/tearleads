---
name: preen-inefficient-resolution
description: Proactively search the monorepo for inefficient module resolution patterns (cyclical imports, empty re-exports, redundant barrels, deep relative imports) and eliminate them. Use when maintaining code quality or during slack time.
---
