...
| `ChildHasNoInheritedFence` | `recordContainerHydrationTombstones` receives only explicitly named discovery targets |
...
Four negative controls erase local work, inherit fences, trust unsigned clocks,
