...
| `PeerPurge` | A different authorized client purges the document; its terminal signed proof permits the later listing tombstone to apply in the positive configuration |
