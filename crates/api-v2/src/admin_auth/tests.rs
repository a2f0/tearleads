...
fn operation_strings_are_stable_for_error_messages() {
    let operations = [
        ...
        (AdminOperation::CreateGroup, "create_group"),
        (AdminOperation::UpdateGroup, "update_group"),
        (AdminOperation::DeleteGroup, "delete_group"),
        (AdminOperation::GetGroupMembers, "get_group_members"),
        (AdminOperation::AddGroupMember, "add_group_member"),
        (AdminOperation::RemoveGroupMember, "remove_group_member"),
