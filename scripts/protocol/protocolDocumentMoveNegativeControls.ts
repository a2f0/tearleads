...
export const DOCUMENT_MOVE_NEGATIVE_CONTROLS: readonly NegativeControl[] = [
  ...
  },
  {
    ...
    why: "An unverified listing tombstone deletes a local link row whose container the signed link set still contains, hiding or re-placing the document locally.",
  },
];
