...
function renderFixture(tlcOutput: string): string {
  ...
  const header = JSON.stringify(
    {
      $generated:
        "Generated by scripts/protocol/generateBaselineDominanceTraces.ts from formal/document-sync/BaselineDominanceTraceExport.tla; do not edit.",
...
if (
  ...
  fail(
    "Usage: bun scripts/protocol/generateBaselineDominanceTraces.ts [--check]",
  );
}
