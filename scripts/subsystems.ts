...
export const subsystems: readonly Subsystem[] = [
  ...
  },
  {
    ...
    paths: [
      ...
      `${api}/realtime/containerInterestRevalidation.ts`,
      `${api}/realtime/containerInterestTypes.ts`,
      `${api}/realtime/hintScoping.ts`,
  ...
  },
  {
    ...
    package: "api",
    responsibility:
      "Package-neutral helpers reused across subsystems: arrays, canonical JSON, cursor encoding, SHA-256, bounded verification caching, SQL dialect, UUID generation, database error classification, and best-effort event publishing.",
  ...
  },
  {
    ...
    paths: [
      ...
      `${sdk}/client/containerDocumentDiscovery.ts`,
    ],
  },
  {
    name: "Container Data",
