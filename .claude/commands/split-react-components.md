---
description: Refactor oversized React component files into small, named, one-component-per-file modules with clear folder organization and colocated tests
---
