...
description: Review the current branch — before or after its PR is opened — with another AI agent (Codex by default, or a fresh Claude Code self-review) and repair blocking findings until the review passes
---
